...
async function fetch(start = 0) {
    let data = await request(getOptions(start));
    return data;
}
...
function getOptions(start) {
    let options = {
        ...
        path: `/c/i/sou?start=${start}&pageSize=100&cityId=801&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=%E5%89%8D%E7%AB%AF&kt=3&_v=0.94922515&x-zp-page-request-id=cfca3a09c69d457395df0ae072a48404-1543657761205-287220`,
        port: 443,
        method: 'GET',
        headers: {
